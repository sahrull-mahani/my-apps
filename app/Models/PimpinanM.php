...
class PimpinanM extends Model
{
    protected $table = 'pimpinan';
    protected $allowedFields = array('nip', 'nama', 'jabatan', 'pangkat');
    ...
    {
        $column_search = array('nip', 'nama', 'jabatan', 'pangkat');
        $i = 0;
...
/* End of file PimpinanM.php */
/* Location: ./app/models/PimpinanM.php */
