...
<div class="row mb-3">
    ...
    <div class="col-sm-9 position-relative">
        <input type="text" class="form-control" id="nip" name="nip[]" value="<?= @$get->nip ?>" placeholder="Contoh: 19292xxxxx" required />
...
<div class="row mb-3">
    ...
    <div class="col-sm-9 position-relative">
        <input type="text" class="form-control" id="pangkat" name="pangkat[]" value="<?= @$get->pangkat ?>" placeholder="Conth: Pembina Massal" required />
        <div class="invalid-tooltip">
