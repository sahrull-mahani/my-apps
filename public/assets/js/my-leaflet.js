// #LEAFLET
var lat = 0.6674043402557894
var lang = 122.51541137695314
...
info.update = function (props) {
    this._div.innerHTML = '<h4>Populasi Provinsi Gorontalo</h4>' + (props ?
        '<b>' + props.Kind + ' ' + props.Name + '</b><br />' + number(props.Populasi) + ' orang / mi<sup>2</sup>'
...
legend.onAdd = function (map) {
    ...
    var div = L.DomUtil.create('div', 'info legend'),
        ...
        labels = [0, '100.000', '120.000', '140.000', '180.000', '200.000', '250.000', '300.000']
